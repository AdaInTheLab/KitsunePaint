          ...
          <div className="flex flex-col gap-6">
            ...
            <section className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <select
                  value={textureGroup}
                  onChange={(e) => setTextureGroup(e.target.value as PaintGroup)}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2">
                    <input type="range" min={1} max={8} value={tilingX}
                      onChange={(e) => setTilingX(Number(e.target.value))}
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2">
                    <input type="range" min={1} max={8} value={tilingY}
                      onChange={(e) => setTilingY(Number(e.target.value))}
                      className="flex-1 accent-amber-400" />
          ...
          <div className="border-t border-zinc-800 pt-8 flex flex-col gap-6">
            ...
            >
              {isBuilding
                ? 'Building modlet...'
                : canDownload
                  ? `⬇ Download "${packName}" Modlet`
                  : 'Add a pack name to download'
              }
            </button>
          </div>
        )}
